                ...
                <div className="relative" style={{ zIndex: 50 }}>
                  ...
                  {showCityDropdown && (
                    <>
                      ...
                      <div className="absolute bottom-full left-0 right-0 mb-1 rounded-md border border-border bg-white dark:bg-gray-900 shadow-xl z-[9999] max-h-40 overflow-y-auto">
                        {citiesLoading ? (
